...
export default function AddProduct() {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between mx-4 my-6 md:mx-20 md:my-16 lg:mx-40 xl:mx-32">
          ...
          >
            <div className="flex justify-between">
              ...
              <input
                ...
                className="sr-only"
              />
              <img className="h-5 mr-2" src="/images/icons/upload.png" alt="" />
            </div>
          </label>
